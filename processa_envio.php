...
try {
    ...
    $mail->Username = 'danielcompositor1307@gmail.com';                 // SMTP username
    $mail->Password = 'amordelouco1307';                           // SMTP password
    $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
    $mail->Port = 587;                                    // TCP port to connect to

    //Recipients
    $mail->setFrom('danielcompositor1307@gmail.com', 'Daniel Rementente');
    $mail->addAddress($mensagem->__get('para'));     // Add a recipient
    //$mail->addAddress('ellen@example.com');               // Name is optional
    //$mail->addReplyTo('daniel.oliveira@agftec.com.br', 'Empresa');
            ...
            <div class="row">
                ...
                <? if($mensagem->status['codigo_status'] == 1){ ?>
                    ...
                    <div class="container">
                        ...
                        <a href="index.php" class="btn btn-outline-success btn-lg mt-5 text-white">Voltar</a>
                    </div>
               <? } ?>
